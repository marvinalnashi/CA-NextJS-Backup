...
const featuresData = [
  {
    ...
    shortText: 'Say goodbye to complicated spreadsheets and manual calculations. With our app, budgeting becomes a breeze. Set up your budget categories',
    aosDelay: '100',
  },
  {
    id: '2',
      ...
      <div id="features" className="py-[50px] md:py-[80px] lg:py-[100px] xl:py-[120px]">
        <div className="container">
          <div
            ...
            data-aos-once="false"
          >
            <h6 className="text-primary-color uppercase text-[16px] md:text-[18px] font-medium mb-[5px]">Key Features</h6>
            <h2 className="text-[28px] md:text-[36px] leading-[36px] md:leading-[45px]">SaaS Made Simple: Drive efficiency and boost performance</h2>
          </div>
              ...
              {featuresData &&
                featuresData.map((value, i) => (
                  ...
                  >
                    ...
                    <h3 className="text-[22px] md:text-[24px] mb-[15px] group-hover:text-white">{value.title}</h3>
